...
public class Game extends JFrame {
    ...
    public static void main(String[] args) throws IOException {
       papich = ImageIO.read(Game.class.getResourceAsStream("sbrf.png"));
       nuts = ImageIO.read(Game.class.getResourceAsStream("redbull.png"));
       end = ImageIO.read(Game.class.getResourceAsStream("eywa.jpg"));
       game_game = new Game();
